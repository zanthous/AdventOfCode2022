...
//				if(which)
//				{
//					//I probably need a way to hash the entire path, and it probably needs to be only one
//					//memo for the both combined. got tired though so done for now
//					//memoPlayer.Add((newPath[newPathLengthM1], minutes.Peek(), currentPressures.Peek()));
//					//memoElephant.Add((newElephantPath[newElephantPathLengthM1], elephantMinutes.Peek(), currentPressures.Peek()));
//					newPathLengthM1--;
//					if(minutes.Count > 0)
//						minutes.Pop();
//				}
