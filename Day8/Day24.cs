...
////I think when considering nodes, I should look ahead in time one minute to see what squares are valid 
...
//	// This function should include any logic for checking if the neighbors are valid (e.g. not out of bounds or blocked)
//	//check in + shape
//	//todo bounds check
